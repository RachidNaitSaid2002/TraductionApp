        ...
        <div className="min-h-screen bg-[#faf9f7] flex items-center justify-center px-4 sm:px-6 md:px-8 py-8 sm:py-12 relative overflow-hidden">
            ...
            <div className="w-full max-w-[1200px]  bg-white rounded-[30px] shadow-2xl overflow-hidden flex flex-col md:flex-row">
                <div className="w-full md:w-1/2 relative h-64 md:h-auto">
                    <div className="relative w-full h-full bg-[#8B5CF6] overflow-hidden flex flex-col justify-between p-2 md:p-5">
                        ...
                        <div className="relative z-10 mt-auto mb-20 md:mb-4 md:ml-4">
                    ...
                    <div className="w-full max-w-md mx-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className='flex justify-between'>
                                {/* Full Name Field */}
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-400" htmlFor="fullname">
                                        Full Name
                                    </label>
                                    <div className="relative">
                                        <input
                            ...
                            <div className="space-y-2">
                                ...
                                <span className='text-center text-[#4A9782] text-sm'>
                                    {message}
                                </span>
                            ...
                            <div className="text-center mt-1">
                                <p className="text-sm text-gray-400">
                                    Nouvel utilisateur? 
                                    <Link href="/login" className="text-[#8B5CF6] font-medium hover:text-[#7C3AED] hover:underline transition-all">
                                        Login
                                    </Link>
                                </p>
                            </div>
